    ...
    >
      <div className="flex justify-between py-10 items-center px-5 lg:px-28 lg:flex-row flex-col-reverse">
        ...
        >
          ...
          {/* DESCRIPTION */}
          <motion.p
            className="text-gray-400 text-sm lg:text-base mt-5 max-w-xl leading-relaxed"
...
>
  {[
    ...
    {
      icon: IoLogoLinkedin,
      link: "https://www.linkedin.com/in/archita-pal-a5a23a2b7/",
      label: "LinkedIn",
    },
    {
      icon: BsGithub,
    ...
    >
      ...
      {/* SKILLS HEADING */}
      <motion.div
        className="flex flex-col items-center mt-20 pb-10"
        initial={{
          opacity: 0,
          y: 30,
        }}
      ...
      >
        ...
        <div className="mt-5 h-[3px] w-20 bg-gradient-to-r from-purple-500 to-cyan-400" />
      </motion.div>
    </div>
  );
}